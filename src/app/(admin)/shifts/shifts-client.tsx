            ...
            <TableBody>
              {shifts.map((shift) => (
                <TableRow key={shift.id}>
                  ...
                  <TableCell className={`text-right font-price font-bold ${Number(shift.difference) < 0 ? 'text-destructive' : Number(shift.difference) > 0 ? 'text-success' : 'text-muted-foreground'}`}>
