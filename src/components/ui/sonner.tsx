  ...
  return (
    <Sonner richColors  
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-card group-[.toaster]:text-foreground group-[.toaster]:border-border/50 group-[.toaster]:shadow-sm group-[.toaster]:rounded-2xl group-[.toaster]:p-4",
